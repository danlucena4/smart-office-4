...
function mockInsights(prompt: string): string {
  ...
  if (lower.includes("sla") || lower.includes("suporte") || lower.includes("chamado")) return "Tempo de atendimento (mock): 7,8h (↓ 12% vs mês anterior). Maior fila: Moderação nos domingos.";
